...
func TestBuffer_Apply_ClampsOutOfBoundsRanges(t *testing.T) {
	...
	b.Apply(
		TextEdit{Range: Range{Start: Pos{Row: 999, GraphemeCol: 999}, End: Pos{Row: 999, GraphemeCol: 999}}, Text: "X"},
		TextEdit{Range: Range{Start: Pos{Row: -5, GraphemeCol: -9}, End: Pos{Row: -5, GraphemeCol: -9}}, Text: "Y"},
	)
...
func TestBuffer_Apply_MultiLineInsertAndFollowupEdit(t *testing.T) {
	...
	b.Apply(
		TextEdit{Range: Range{Start: Pos{Row: 0, GraphemeCol: 1}, End: Pos{Row: 0, GraphemeCol: 1}}, Text: "\n"},
		TextEdit{Range: Range{Start: Pos{Row: 1, GraphemeCol: 0}, End: Pos{Row: 1, GraphemeCol: 0}}, Text: "b"},
	)
...
func TestBuffer_Apply_NoOpDoesNotBumpVersion(t *testing.T) {
	...
	b.Apply(TextEdit{Range: Range{Start: Pos{Row: 0, GraphemeCol: 0}, End: Pos{Row: 0, GraphemeCol: 0}}, Text: ""})
