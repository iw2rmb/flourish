...
func TestScrollbarMouse_VerticalThumbDrag(t *testing.T) {
	...
	m, _ = m.Update(testMouseClick(x, startY, tea.MouseLeft))
	m, _ = m.Update(testMouseMotion(x, endY, tea.MouseNone))
	m, _ = m.Update(testMouseRelease(x, endY, tea.MouseLeft))
...
func TestScrollbarMouse_VerticalTrackClickPages(t *testing.T) {
	...
	m, _ = m.Update(testMouseClick(x, downY, tea.MouseLeft))
	...
	m, _ = m.Update(testMouseClick(x, upY, tea.MouseLeft))
...
func TestScrollbarMouse_HorizontalThumbDrag(t *testing.T) {
	...
	m, _ = m.Update(testMouseClick(startX, y, tea.MouseLeft))
	m, _ = m.Update(testMouseMotion(endX, y, tea.MouseNone))
	m, _ = m.Update(testMouseRelease(endX, y, tea.MouseLeft))
...
func TestScrollbarMouse_HorizontalTrackClickPages(t *testing.T) {
	...
	m, _ = m.Update(testMouseClick(rightX, y, tea.MouseLeft))
	...
	m, _ = m.Update(testMouseClick(leftX, y, tea.MouseLeft))
...
func TestScrollbarMouse_ScrollFollowCursorOnly_BlocksScrollbarManualActions(t *testing.T) {
	...
	m, _ = m.Update(testMouseClick(x, metrics.contentHeight-1, tea.MouseLeft))
	if got, want := m.ViewportState().TopVisualRow, 0; got != want {
		t.Fatalf("top row after blocked scrollbar press: got %d, want %d", got, want)
	}

	m, _ = m.Update(testMouseClick(x, metrics.vThumbPos, tea.MouseLeft))
	m, _ = m.Update(testMouseMotion(x, metrics.contentHeight-1, tea.MouseNone))
	m, _ = m.Update(testMouseRelease(x, metrics.contentHeight-1, tea.MouseLeft))
	if got, want := m.ViewportState().TopVisualRow, 0; got != want {
